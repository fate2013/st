...
<div class="main">
    <div class='left_content'>
        <div class='portrait'>
            <a href='/user/portrait' style='float:left'><img class='portrait_img' width='120px' height='120px' src='<?php echo Yii::app()->session['user']->profile? Yii::app()->session['user']->profile->portrait : '/images/tx.png';?>' /></a>
        </div>
